...
CADR_SRCS   := $(sort $(wildcard cadr/*.vhd) $(AUTOGENERATED_CADR_TB))
...
EXES := $(CADR_EXES) $(DIP_EXES) $(HELPER_EXES) $(TTL_EXES)
...
$(AUTOGENERATED_CADR_TB): $(CREATE_TB_PY) cadr/cadr_book.vhd cadr/icmem_book.vhd helper/helper.vhd
	python3 $< \
