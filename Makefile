...
# test data
AUTOGENERATED_TESTDATA := build/sn74181_tb.txt build/alu_8bit_tb.txt build/alu_16bit_tb.txt build/alu_32bit_tb.txt build/cadr_alu_tb.txt
...
# autogenerated test data for 8-bit alu
build/alu_8bit_tb.txt: scripts/generate-alu-testdata.py
	mkdir -p $(BUILDDIR)
	python3 $< --width 8 > $@
