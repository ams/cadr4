...
# test dataAdd commentMore actions
...
# autogenerated test data for sn74181Add commentMore actions
...
.PHONY: all sources check-ttl check-cadr check run-% run-tb wf-% wf-tb clean distclean help
...
help: 
	...
	@echo "make distclean: clean and also remove autogenerated source files"
