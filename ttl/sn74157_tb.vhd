...
begin
  ...
  begin
    ...
    -- Test 1: Strobe high (enb_n = '1') - all outputs low (the '157 is not three-state)
    enb_n <= '1';
    sel <= '0';
    a1 <= '1'; a2 <= '1'; a3 <= '1'; a4 <= '1';
    b1 <= '1'; b2 <= '1'; b3 <= '1'; b4 <= '1';
    ...
    assert y1 = '0' and y2 = '0' and y3 = '0' and y4 = '0'
      report "Test 1 failed: outputs should be '0' when strobe is high" severity error;
    ...
    wait for 10 ns;
    assert y1 = '0' and y2 = '0' and y3 = '0' and y4 = '0'
      report "Test 8b failed: outputs should be '0' after strobe goes high" severity error;
